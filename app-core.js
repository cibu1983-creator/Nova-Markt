const DB={
  ...
  safeReturn(v){if(!v)return'';try{const d=decodeURIComponent(v);if(/^https?:/i.test(d)||d.startsWith('//')||d.includes('\\'))return'';if(!/^[a-zA-Z0-9_.?=&%#-]+$/.test(d))return'';return d}catch{return''}}
};
window.DB=DB;
